...
class ChatService:
    ...
    def chat(
        ...
        logger.debug("ChatService.chat: self._chat_engine...")
        ...
        logger.debug("api: messages: %s, \n context_filter: %s", last_message if last_message is not None else "", context_filter )
        logger.debug("api: response: %s", wrapped_response.response)
